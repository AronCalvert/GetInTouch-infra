# CS4135 Software Architecture Project: Get In Touch - Infra

Visit the [wiki page](https://github.com/VenturiVen/GetInTouch-infra/wiki) to see documentation.

Visit the [backend repository](https://github.com/AronCalvert/CS4135-Software-Architecture) and [frontend repository](https://github.com/AronCalvert/GetInTouch-infra).
